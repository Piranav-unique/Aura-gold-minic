...
void main() {
  ...
  testWidgets('PermissionsScreen renders correctly with data', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('RolesScreen renders correctly with data', (
    WidgetTester tester,
  ) async {
    tester.view.physicalSize = const Size(1280, 800);
    tester.view.devicePixelRatio = 1.0;
  ...
  testWidgets(
    'UsersScreen desktop layout renders and handles status toggle & delete',
    (WidgetTester tester) async {
      ...
      when(() => mockApi.delete(any())).thenAnswer((_) async => mockResponse);
      ...
      verify(
        () => mockApi.put('/users/u1', data: {'is_active': false}),
      ).called(1);
  ...
  testWidgets(
    'UsersScreen mobile layout renders and handles status toggle & delete',
    (WidgetTester tester) async {
  ...
  testWidgets('ProfileScreen renders correctly with data', (
    WidgetTester tester,
  ) async {
    tester.view.physicalSize = const Size(1280, 800);
    tester.view.devicePixelRatio = 1.0;
